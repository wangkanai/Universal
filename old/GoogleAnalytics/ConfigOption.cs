...
namespace GoogleAnalytics
{
    public class ConfigOption : FieldOption
    {
        ...
        /// <summary>
        /// Specifies what percentage of users should be tracked. This defaults to 100 (no users are sampled out) but large sites may need to use a lower sample rate to stay within Google GoogleAnalytics processing limits.
        /// </summary>
        ...
        /// <summary>
        /// This field is used to configure how analytics.js searches for cookies generated by earlier Google GoogleAnalytics tracking scripts such as ga.js and urchin.js.
        /// </summary>
